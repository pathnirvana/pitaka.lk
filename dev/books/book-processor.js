...
const bookList = [
    { name: 'පන්සිය පණස් ජාතකය', author: 'ජාතක අටුවාව', folder: 'pansiya-panas-jathaka', group: 1, files: ['වෙනත්', '', ''], gen: 'html' }, //html, pdf, non-gen pdf
    { name: 'මහාවංශය', author: 'සිංහල පරිවර්තනය', folder: 'mahavanshaya', group: 1, files: ['ඉපැරණි පොත්', 1176, 1177, 60], gen: '' },
    { name: 'පැරණි බුදුසිරිත', author: 'සම්පිණ්ඩිතමහානිදානය', folder: 'sampinditha-mahanidanaya', group: 1, files: ['වෙනත්', 1174, 1175, 768], gen: '' },
